...
BASE_BRANCH=$(git rev-parse --abbrev-ref origin/${{ github.event.pull_request.base.ref }})
HEAD_BRANCH=$(git rev-parse --abbrev-ref HEAD)
PR_BASE_SHA=$(git merge-base origin/${{ github.event.pull_request.base.ref }} $HEAD_BRANCH)
